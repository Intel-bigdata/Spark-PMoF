...
- Launch proxy
  ```./proxyMain --current_proxy_addr $addr [--log $log_path]```
...
data server logs are recorded in $RPMP_HOME/log/rpmp-proxy.log and $RPMP_HOME/log/rpmp-server.log respectively.
