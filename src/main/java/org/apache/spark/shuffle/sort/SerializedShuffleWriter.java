...
@Private
public class SerializedShuffleWriter<K, V> extends ShuffleWriter<K, V> {

    private static final Logger logger = LoggerFactory.getLogger(SerializedShuffleWriter.class);
    ...
    public SerializedShuffleWriter(
            ...
            SparkConf sparkConf,
            boolean enable_rdma) throws IOException {
        ...
        this.inputBufferSizeInBytes =
                Integer.parseInt(sparkConf.get(package$.MODULE$.SHUFFLE_FILE_BUFFER_SIZE()).toString()) * 1024;
        this.outputBufferSizeInBytes =
                Integer.parseInt(sparkConf.get(package$.MODULE$.SHUFFLE_UNSAFE_FILE_OUTPUT_BUFFER_SIZE()).toString()) * 1024;
        open();
    }
